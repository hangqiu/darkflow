...
CKPT=$3
mkdir $RESDIR
echo flow --imgdir $EVALSET --model $MODEL --restore $CKPT --labels $NAMES --gpu 0.3 --threshold 0.01 --json
flow --imgdir $EVALSET --model $MODEL --restore $CKPT --labels $NAMES --gpu 0.3 --threshold 0.01 --json
